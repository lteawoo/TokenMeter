...
const REPOSITORY_URL = "https://github.com/lteawoo/TokenMeter";
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  className="h-[26px] w-[26px] rounded-full border-white/10 bg-transparent p-0 text-white/90 hover:bg-white/8 hover:text-white"
                  onClick={() => {
